...
import com.decagon.android.sq007.pokemon.Move

class PokemonMoveAdapter(val pokemonMovesList: List<Move>) :
    RecyclerView.Adapter<PokemonMoveAdapter.PokemonMovesViewHolder>() {
